...
jQuery(function(c) {
        ...
        991 < E && (c(".main-navigation .menu-item a, .main-navigation .menu-item .removed-link").on("mouseenter", function() {
            ...
            "A" != t.target.nodeName && "a" != t.target.nodeName && (t.stopPropagation(), c(this).toggleClass("open"), c(this).find(".sub-menu:first").slideToggle())
        }), c(".entry-content table").wrap(c("<div class='table-responsive' />")), c(".js-social-link").click(function() {
            ...
            i(), n()
        }), n(), 1 == settings_array.lightbox_display && c(".entry-content").find("a:has(img)").wpshoplightbox()
    }),
    function(i, a, s) {
        "use strict";
...
// ❌ ОТКЛЮЧЕНО: MoeVideo реклама (мобила + ПК)
// function initMoeVideoAd(e) {
//     if (document.getElementById("mvcontentroll")) return;
//     const t = document.createElement("div");
//     t.id = "mvcontentroll", document.body.appendChild(t);
//     const n = document.createElement("script");
//     n.src = "https://cdn1.moe.video/p/cr.js", n.onload = () => {
//         addContentRoll({
...
document.addEventListener("DOMContentLoaded", (function() {
    ...
    // Мобильные fullscreen
    e && window.yaContextCb.push((() => {
        Ya.Context.AdvManager.render({
            blockId: "R-A-15627427-3",
            type: "fullscreen",
            platform: "touch"
        })
    }));

    // Мобильный floorAd (MoeVideo отключен)
    e && window.yaContextCb.push((() => {
        Ya.Context.AdvManager.render({
            ...
            platform: "touch"
            // onClose: () => {
            //     initMoeVideoAd("mobile"); // отключено
            // }
        })
    }));
    ...
    // ОТКЛЮЧЕНО: MoeVideo на ПК
    // !t && !n && initMoeVideoAd("desktop");

    // ОТКЛЮЧЕНО: Яндекс floating (сайдбар)
    // (e || t || n) || initFloatingAds()
